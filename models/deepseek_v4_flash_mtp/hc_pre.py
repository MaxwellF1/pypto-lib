...
PREFILL_HC_PRE_T_DYN = pl.dynamic("PREFILL_HC_PRE_T_DYN")
...
@pl.jit.inline
def prefill_hc_pre(
    x: pl.Tensor[[PREFILL_HC_PRE_T_DYN, HC_MULT, D], pl.FP32],
    hc_fn: pl.Tensor[[MIX_HC, HC_DIM], pl.FP32],
    hc_scale: pl.Tensor[[3], pl.FP32],
    hc_base: pl.Tensor[[MIX_HC], pl.FP32],
    x_mixed: pl.Tensor[[PREFILL_HC_PRE_T_DYN, D], pl.BF16],
    post: pl.Tensor[[PREFILL_HC_PRE_T_DYN, HC_MULT], pl.FP32],
    comb: pl.Tensor[[PREFILL_HC_PRE_T_DYN, HC_MULT * HC_MULT], pl.FP32],
